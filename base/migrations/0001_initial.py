# Generated by Django 5.2.7 on 2025-10-09 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(blank=True, max_length=2047, null=True, verbose_name='متن بلاگ')),
                ...
                ('readers', models.ManyToManyField(blank=True, related_name='blogs', to=settings.AUTH_USER_MODEL, verbose_name='خواننده ها')),
            ],
            options={
                'verbose_name': 'بلاگ',
